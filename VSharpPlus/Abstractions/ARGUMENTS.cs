...
namespace VSharpPlus.Abstractions
{
    ...
    {
        public static readonly string User = "photo_id,verified,sex,bdate,city,country,home_town,has_photo,photo_50," +
                                             "photo_100,photo_200_orig,photo_400_orig,photo_200,photo_max,photo_max_orig," +
                                             "online,domain,has_mobile,contacts,site,education,universities,schools,status," +
                                             "last_seen,followers_count,occupation,nickname,relatives," +
                                             "relation,personal,connections,exports,activities,interests,music,movies,tv," +
        ...
        public static readonly string UserExtra = "common_count";
